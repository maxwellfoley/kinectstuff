(function() {
  ...
  $(function() {
    ...
    if (!(window.WebGLRenderingContext && document.createElement('canvas').getContext('experimental-webgl') && window.WebSocket && new WebSocket('ws://localhost:9000/').binaryType)) {
      $('#noWebGL').show();
      return;
    }
    params = {
    ...
    //this is where it gets data from the blob
